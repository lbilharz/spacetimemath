    ...
    <PageContainer className="pb-[100px] sm:pb-[140px]">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          ...
          >
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-slate-50 dark:bg-slate-900/50 transition-colors group-hover:bg-brand-yellow/10">
              <InviteLinkIcon className="scale-110 transition-transform group-hover:scale-[1.2] group-hover:drop-shadow-sm" />
            </div>
          ...
          <div className="rounded-3xl border-2 border-brand-yellow/50 bg-brand-yellow/5 p-6 animate-in fade-in zoom-in-95 duration-300 flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="flex-1 flex flex-col w-full text-center md:text-left">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={handleCopy}
                  className="shrink-0 rounded-xl px-4 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold transition-transform active:scale-95 text-sm"
                >
