...
import type { Answer, ClassSprint, Classroom, ClassroomMember, Player, ProblemStat, Session, NextProblemResultV2, IssuedProblemResultV2 } from '../module_bindings/types.js';
  ...
  if (activeSprint) {
    return (
      <ClassroomLiveSprintView
        ...
        nextProblemResults={nextProblemResults as unknown as NextProblemResultV2[]}
        issuedProblemResults={issuedProblemResults as unknown as IssuedProblemResultV2[]}
